...
if (!isset($_SESSION['bookconfirmed'])) {
                                ...
                                <div id="inner-prettification">
                                    ...
                                    <div id="contents">
                                        ...
                                        ?>
                                            ...
                                            <p>Congratulations <b><?php echo $session->username; ?></b>, your booking was successful.<br />
                                                You will receive email confirmation shortly.</p>
                                            <div class="contentbox" style="background-color: #e5e5e5; width:45em;">
                                                <p><b>-> Your Booking Ref: <?php echo $_SESSION['bookingref']; ?></b></p>
                                            </div>
                                            <p>Please keep a safe record of this number. You can use it to check the details of your booking at
                                                any time, just enter it on the My Bookings page along with your username.</p>
                                            <p>If you want, you can click below to check your booking now.</p>
                                            <form action="process.php" method="post">
                                                <input type="hidden" name="subchecknow" value="1" />
                                                <p><input type="submit" value="-> Check Now" /></p>
                                            </form>
                                            <div class="contentbox" style="font-size: small; width:45em;">For information on what to do when you get to the airport, please read our <a href="info.php">Travel Information</a> section.</div>
                                        <?
                                        }
                                        /* Shouldn;t get here */ else {
