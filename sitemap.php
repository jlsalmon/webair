    ...
    <body>
        ...
        <div id="window">
            <div id="container">
                ...
                <div id="main-head">
                    <a href="index.php" title="WebAir Homepage">
                    ...
                    <table class="smalltext" style="font-size:10px; vertical-align:top; clear:both; float:right;">
                        <tr>
                            <td valign="top">
                                ...
                                ?>
                                    <form action="process.php" method="post" style="float:right;"><?php
                                    /**
                                ...
                                ?><span>Login: </span>
                                    ...
                                    <input type="checkbox" name="remember" class="smalltext"<?php
                        ...
                        <tr>
                            <td><?php echo $form->error("user"); ?><br /><?php echo $form->error("pass"); ?></td>
                        </tr><?php } ?>
                    </table>
                </div>
                <div id="navigation">
                ...
                <div id="main">
                    <div id="outer-prettification">
                        <div id="inner-prettification">
                            ...
                            <div id="header">
                                <h1 id="title"><a href="sitemap.php"></a></h1>
                            </div>
                            ...
                            <div id="contents">
                                <div class="comment" style="background-color: #3B5998; color:white;">
                                    ...
                                    <div class="contents" style="width: auto; color: black;">
                                        ...
                                        <span>Home tab</span>
                                        <ul>
                                            <li><a href="index.php">Related Links</a></li>
                                            <li><a href="index.php">Book a Flight</a></li>
                                            <li><a href="index.php">Manage Bookings</a></li>
                                        </ul><span>My Bookings tab</span>
                                        <ul>
                                            <li><a href="main.php">Register a New Account</a></li>
                                            <li><a href="main.php">Book a Flight</a></li>
                                            <li><a href="main.php">Manage Bookings</a></li>
                                        </ul><span>My Account tab</span>
                                        <ul>
                                            <li><a href="userinfo.php?user=<?php echo $session->username; ?>.php">Edit Account Details</a></li>
                                            <li><a href="forgotpass.php">Reset Password</a></li>
                                        </ul>
                                        <span>Travel Information tab</span>
                                        <ul>
                                            <li><a href="info.php">Timetables and Fares</a></li>
                                            <li><a href="info.php">Check-in Information</a></li>
                                            <li><a href="info.php">Baggage Information</a></li>
                                            <li><a href="info.php">Travel Documentation Requirements</a></li>
                                        </ul>
                                        <span>About tab</span>
                                        <ul>
