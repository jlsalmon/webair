                            ...
                            <div id="outer-prettification">
                                <div id="inner-prettification">
                                    ...
                                    <div id="contents">
                                        ...
                                        <?php
                                        if (isset($_SESSION['lookupsuccess'])) {
                                        ?>
                                            <div class="contentbox" style="background-color: #e5e5e5; width: 40em;">
                                                <img alt="information"  src="/layout/images/info.png" />
                                                <h2>Your Booking Details:</h2>
                                                <p><table class="flat-lined" style="width:inherit; background-color: #fafafa;">
                                                        <tr>
                                                            <td>Booking Ref:</td>
                                                            <td><b><?php echo $_SESSION['bookingref']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Flight Origin:</td>
                                                            <td><b><?php echo $_SESSION['l_origin']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Flight Destination:</td>
                                                            <td><b><?php echo $_SESSION['l_dest']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Departure Date:</td>
                                                            <td><b><?php echo $_SESSION['l_depdate']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Departure Time:</td>
                                                            <td><b><?php echo $_SESSION['l_deptime']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Arrival Time:</td>
                                                            <td><b><?php echo $_SESSION['l_arrtime']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Number of Adults:</td>
                                                            <td><b><?php echo $_SESSION['l_numadult']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Number of Children:</td>
                                                            <td><b><?php echo $_SESSION['l_numchild']; ?></b></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Date Order Placed:</td>
                                                            <td><b><?php echo $_SESSION['l_orderdate']; ?></b></td>
                                                        </tr>

                                                    </table></p>
                                                <br />
                                                <p style="font-size: small;"><em><b>Please keep a safe record of these details.</b> We look forward to having you fly with us!
                                                        If you believe your booking to be incorrect, please do not hesitate to contact us on
                                                        <b><a href="mailto:info@web-air.co.uk">info@web-air.co.uk.</a></b></em>
                                                </p>
                                            </div>     
                                        <?
                                        }
