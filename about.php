...
<meta name="copyright" content="All content (c) WebAir" /><title>WebAir | About This Site</title>
...
<div id="window">
<div id="container">
<div id="main-head"> <a href="index.php" title="WebAir Homepage"><img alt="webair logo" src="layout/images/webair-logo-small.png" /></a>
...
<!--[if IE 6]><li></li><![endif]--> <li><a href="index.php">Home</a></li>
<li><a href="main.php">My Bookings</a></li>
<li><a href="userinfo.php?user=<?php echo $session->username; ?>">My
Account</a></li>
...
<div id="contents">
<div class="comment" style="background-color: rgb(59, 89, 152); color: white;">
<div class="contentbox" style="width: auto;">
<p> </p>
<h3>About This Site</h3>
<h4>Authors:</h4>
Justin Salmon - Lead Developer/Designer<br />
Tommy Plummer - Maintenance<br />
Alex Dixon - Quality Assurance<br />
Steven Hoang - Legal Advisor
<p> </p>
<h4>Credits:</h4>
<em><a href="http://www.oswd.org">Open Source Web
Design</a> for their brilliant web template</em><br />
<em><a href="http://www.eyecon.ro/datepicker">Stefan
Petre's</a> datepicker scripts</em><br />
<em><a href="http://www.javascripttoolbox.com/lib/dynamicoptionlist/">Matt
Kruse's</a> dynamic dropdown scripts</em><br />
</div>
</div>
</div>
<div id="footer">
<p><a href="http://www.web-air.co.uk" title="Copyrighted">v1.0.1 © WebAir 2010</a></p>
</div>
</div>
</div>
<p style="text-align: center; font-size: 12px;"> <a href="privacy.php">Privacy</a> | <a href="sitemap.php">Sitemap</a> | <a href="contact.php">Contact Us</a> </p>
<p style="text-align: right; width: 68em;"> <a href="http://validator.w3.org/check?uri=referer"><img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Transitional" height="31" width="88" /></a>
<a href="http://jigsaw.w3.org/css-validator/check/referer">
<img style="border: 0pt none ; width: 88px; height: 31px;" src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" /> </a> </p>
</div>
</div>
</div>
</body></html>