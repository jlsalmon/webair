                                    ...
                                    <div id="contents">
                                        <div class="comment" style="background-color: #3B5998; color:white;">
                                            <div class="contents" style="width: auto; color: black;">
                                                ...
                                                <span>
                                                    <p><h3>By Telephone:</h3>
                                                    For all enquiries, please contact this below phone number. Enquires include reservations in general, lost and claim baggage, flight arrival and departure information and group sales.
                                                    <br /><br />
                                                    <b>Telephone number:  0800 516 765</b><br />
                                                    (Please note opening hours are between 8:00am – 4:00pm.)<br /><br />
                                                    <h3>Or Contact us by email:</h3>
                                                    <b>enquiries@webair.co.uk</b></p>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
