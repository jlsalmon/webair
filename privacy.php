                ...
                <div id="main">
                    <div id="outer-prettification">
                        <div id="inner-prettification">
                            ...
                            <div id="header">
                                <h1 id="title"><a href="privacy.php"></a></h1>
                            </div>

                            <div id="contents">
                                <div class="comment" style="background-color: #3B5998; color:white;">
                                    <div class="contents" style="width: auto; color: black;">
                                        <p><h3>Privacy Policy</h3><br />
                                        <span>
                                            Here at WebAir, we take our customer's privacy very seriously.<br />
                                            That's why we spent so long writing this page.
                                        </span><br /><br />
                                        </p>
                                    </div>
                                </div>
